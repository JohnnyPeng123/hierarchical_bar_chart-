...
chart <- hbar(data,js.path="hbar.js",groupings,method="count",num_variable=NULL,na.rm=T)
chart

hbar <- function(data,js.path,groupings,method,num_variable=NULL,na.rm=T){
  ...
  return(r2d3(data=output, script = js.path))
}
