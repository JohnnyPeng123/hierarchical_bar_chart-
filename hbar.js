// !preview r2d3 data=fromJSON(file="flare-2.json")
//
...
root = d3.hierarchy(data)
         ...
         .sort((a, b) => b.value - a.value)
          .eachAfter(d => d.index = d.parent ? d.parent.index = d.parent.index 
          + 1 || 0 : 0);

color = color = d3.scaleOrdinal([true, false], ["steelblue", "#aaa"]);
